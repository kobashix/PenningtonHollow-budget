...
CREATE INDEX idx_budget_items_phase ON budget_items(phase);
...
-- Process #1-6: Property/Shed (CASH)
...
-- Process #7-11: Planning/Foundation (7 is FINANCE, rest CASH)
...
-- Process #24-26: Finalization (CASH)
